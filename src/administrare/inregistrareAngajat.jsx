...
const InregistrareAngajat = ()  => {
    ...
    const registerHandler= async (e)=>{
        ...
        try {
            await axiosJWT.post("http://localhost:3001/private/registerAngajat",{email,cnp,parola,nume,prenume,telefon,adresa},config);
...
export default InregistrareAngajat;
